    ...
    <div className="space-y-8 animate-in fade-in duration-150">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          icon={Activity}
          change={healthScore >= 70 ? 'Strong Index' : healthScore >= 50 ? 'Moderate Index' : 'Pending Onboarding'}
        ...
        <StatCard
          ...
          icon={Wallet}
          change={isCompleted ? `₹${totalExpenses.toLocaleString('en-IN')} total expenses` : 'Pending Onboarding'}
          changeType="positive"
        />
        <StatCard
          ...
          icon={PiggyBank}
          change={isCompleted ? `${savingsRatePct}% savings rate` : 'Pending Onboarding'}
        ...
        <StatCard
          ...
          icon={ShieldCheck}
          change={isCompleted ? `${emergencyMonths} months buffer` : '0 months buffer'}
          changeType={Number(emergencyMonths) >= 3 ? 'positive' : 'neutral'}
        />
      </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-900 border border-emerald-500/30 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div className="p-3 rounded-xl bg-slate-900/80 border border-slate-800 text-[11px] text-slate-400 font-mono italic">
              "What is my monthly surplus? Give me the exact calculation using my profile."
            </div>
          </div>
