...
export default function AiPage() {
  const [messages, setMessages] = useState([
    {
      sender: 'ai',
      text: "Hello Alex 👋 I'm your FinLabs AI financial copilot. I analyze your financial health, goals, and risk profile to answer any question about your money."
    }
  ]);
  ...
  const handleSend = (textToSend) => {
    ...
    setTimeout(() => {
      let response = "Based on your FinLabs profile (Health Score 74/100, 20% savings rate), increasing equity allocation via SIP compound interest is your strongest path to target goals.";
      if (text.includes('74')) {
        response = "Your score of 74 is driven by strong savings rate (20%) and low debt (12%). Your main bottleneck is emergency reserves (4.5 months vs recommended 6.0 months).";
      } else if (text.includes('Downpayment') || text.includes('goal')) {
        response = "Your Home Downpayment goal requires ₹15,00,000 by 2028 (currently ₹6,30,000). Increasing your monthly contribution by ₹2,000 will reach target 14 months earlier.";
      }
